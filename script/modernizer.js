 ...
 * http://modernizr.com/download/?-adownload-ambientlight-animation-appearance-applicationcache-audio-audioloop-audiopreload-backdropfilter-backgroundblendmode-backgroundcliptext-batteryapi-blobconstructor-canvas-canvasblending-canvastext-canvaswinding-contenteditable-contextmenu-cookies-cors-cryptography-cssall-cssanimations-customevent-customprotocolhandler-dart-dataview-emoji-eventlistener-exiforientation-flash-fullscreen-gamepads-geolocation-getrandomvalues-hashchange-hiddenscroll-history-htmlimports-ie8compat-indexeddb-indexeddbblob-input-inputtypes-intl-json-lowbattery-mathml-notification-olreversed-pagevisibility-performance-pointerevents-pointerlock-postmessage-proximity-queryselector-quotamanagement-requestanimationframe-search-serviceworker-svg-templatestrings-todataurljpeg_todataurlpng_todataurlwebp-touchevents-typedarrays-unicode-unicoderange-userdata-vibrate-video-vml-webaudio-webgl-webintents-websockets-webworkers-xdomainrequest !*/ !(function (
  ...
  function testProps(A, e, t, n) {
    ...
    for (var i, a, d, w, s, l = ["modernizr", "tspan"]; !mStyle.style; )
      (i = !0),
    ...
    for (d = A.length, a = 0; d > a; a++)
      if (
        ((w = A[a]),
        (s = mStyle.style[w]),
        contains(w, "-") && (w = cssToDOM(w)),
        mStyle.style[w] !== undefined)
      ) {
  ...
  Modernizr.addTest("audio", function () {
    ...
    try {
      (e = !!A.canPlayType) &&
        ...
        (e.opus = A.canPlayType('audio/ogg; codecs="opus"').replace(
          /^no$/,
          ""
        )),
  ...
  var hasEvent = (function (A) {
    function e(e, n) {
      var r;
      return e
        ? ((n && "string" != typeof n) || (n = createElement(n || "div")),
          (e = "on" + e),
          (r = e in n),
          !r &&
            t &&
            (n.setAttribute || (n = createElement("div")),
            n.setAttribute(e, ""),
  ...
  Modernizr.inputtypes = (function (A) {
    for (var e, t, n, r = A.length, o = ":)", i = 0; r > i; i++)
    ...
    Modernizr.addAsyncTest(function () {
      ...
      if (
        ...
        if (
          ...
          return t(w), r("blocked", d), void n(w);
        (i = function () {
          return (
            t(w),
            docElement.contains(w)
    ...
    Modernizr.addTest("unicode", function () {
      ...
      return (
        testStyles(
          ...
          function (n) {
            (e.innerHTML = isSVG ? "å¦‡" : "&#5987"),
              (t.innerHTML = isSVG ? "â˜†" : "&#9734"),
              n.appendChild(e),
              n.appendChild(t),
